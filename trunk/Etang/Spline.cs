    ...
    public static class ClosedBezierSpline
    {
            ...
            out Vector2[] firstControlPoints, out Vector2[] secondControlPoints)
        {
            ...
            { // There should be at least 3 knots to draw closed curve.
                firstControlPoints = new Vector2[0];
                secondControlPoints = new Vector2[0];
                return;
            }
            ...
            {
                // First control point.
                firstControlPoints[i] = new Vector2((float)x[i], (float)y[i]);
                // Second control point.
                secondControlPoints[i] = new Vector2
                    (2 * knots[i].X - (float)x[i], 2 * knots[i].Y - (float)y[i]);
            }
        }
    }
